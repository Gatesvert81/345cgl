...
function Footer() {
    return (
        <footer className='w-full flex flex-col md:flex-row gap-5 justify-start md:justify-between items-center md:items-end pb-10 px-side bg-main-bg '>
            <div className='flex flex-col justify-start items-start gap-2' >
                ...
                <p className='normal__text' >
                    Location: Dorwanya, Ghana.
                </p>
                <p className='normal__text' >
                    Email: 345constructiongroupltd@gmail.com
                </p>
                <p className='normal__text' >
                    Phone: 030 394 2600
                </p>
            ...
            <div className='flex flex-row md:flex-col justify-start md:justify-end gap-3 items-center md:items-start ' >
                <AnchorLink route="https://web.facebook.com/345constructiongroup" pass={true} target={true} >
                    <div className='flex flex-row justify-between gap-3 items-center cursor-pointer ' >
                        <div className='w-8 h-8 relative' >
                            <Image src={fb} layout="fill" />
                        </div>
                        <p className='normal__text' >345construction</p>
                    </div>
                </AnchorLink>
                <div className='flex flex-row justify-between gap-3 items-center cursor-pointer' >
                    <div className='w-8 h-8 relative' >
                    ...
                    <div className='flex flex-col gap-1' >
                        <AnchorLink route='https://wa.me/+233508521652' pass={true} target={true}>
                            <p className='normal__text' >
                                +233 276 622 104
                            </p>
                        </AnchorLink>
